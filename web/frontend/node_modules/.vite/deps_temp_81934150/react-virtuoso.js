  ...
  const d = import_react.default.useCallback(
    (m) => {
      ...
      o({
        ...
        l ? Sn("column-gap", getComputedStyle(m).columnGap, r) : Sn("row-gap", getComputedStyle(m).rowGap, r)
      ), v !== null && t(v);
    },
    [t, e, r, s, i, o, l]
  );
...
function Ue(t, e, n) {
  const o = import_react.default.useRef(null), r = import_react.default.useCallback(
    ...
    [t, e]
  ), { callbackRef: s, ref: i } = $e(r, true, n), l = import_react.default.useCallback(() => {
    r(i.current);
  }, [r, i]);
...
function vt(t, e, n) {
  return J(t) ? Un(e, n, 1) : e === t.k ? dt(t, { k: e, v: n }) : e < t.k ? xn(dt(t, { l: vt(t.l, e, n) })) : xn(dt(t, { r: vt(t.r, e, n) }));
}
function Yt() {
  return se;
}
...
var kt = j(
  ([{ log: t }, { recalcInProgress: e }]) => {
    const n = U(), o = U(), r = ht(o, 0), s = U(), i = U(), l = T(0), c = T([]), d = T(void 0), m = T(void 0), v = T(void 0), p = T(void 0), I = T((u, g) => Ht(u, $o[g])), w = T(void 0), R = T(0), h = Vo(), f = ht(
      x(n, $(c, t, R), Ot(Mo, h), nt()),
      h
    ), a = ht(
      x(
        c,
  ...
  ([{ defaultItemSize: t, listRefresh: e, sizes: n }, { scrollTop: o }, { scrollTargetReached: r, scrollToIndex: s }, { didMount: i }]) => {
    ...
    return z(
      ...
      x(
        at(e, i),
        $(l, n, t, d),
        P(([[, m], v, { sizeTree: p }, I, w]) => m && (!J(p) || Ne(I)) && !v && !w),
        $(c)
      ),
      ([, m]) => {
        if (m === void 0) {
...
var pe = j(([{ footerHeight: t, headerHeight: e, scrollBy: n, scrollContainerState: o, scrollTop: r, viewportHeight: s }]) => {
  const i = T(false), l = T(true), c = U(), d = U(), m = T(4), v = T(Zo), p = ht(
    x(
      Fe(x(W(r), Ut(1), Bt(true)), x(W(r), Ut(1), Bt(false), hn(100))),
      nt()
    ),
    false
  ), I = ht(
    x(Fe(x(n, Bt(true)), x(n, Bt(false), hn(200))), nt()),
    false
  );
  z(
    x(
      ...
      x(
        ...
        B(
          ([
            ...
            return I -= a, I += p + f, w += p + f, w -= a, I > m + y - g && (u = ue), w < m - L + v + C && (u = ne), u !== Tn ? [
...
function to(t, e, n, o, r, s) {
  ...
  const l = t + i, c = Ye(e, l), d = Array.from({ length: l }).map((m, v) => ({
    data: s[v + c],
    index: v + c,
    offset: 0,
    size: 0
      ...
      x(
        ...
        B(
          ([
            ...
            if (u === 0 && g === 0)
              return St === 0 ? { ...Oe, totalCount: C } : to(St, O, k, Z, F, q || []);
            if (J(lt))
              return St > 0 ? null : ve(
                Xo(Ye(O, C), Q, q),
                [],
  ...
  ([
    ...
    return z(
      x(
        ...
        $(t),
        B(([[v, p, I, w, R, h, f, a], S]) => {
          const { calculateViewLocation: H = Qo, done: y, ...L } = v, u = Zn(v, p, w - 1), g = ce(u, p.offsetTree, S) + R + h, C = g + Rt(p.sizeTree, u)[1], k = a + h, O = a + I - f, V = H({
            itemBottom: C,
            itemTop: g,
            locationParams: L,
            viewportBottom: O,
  ...
  ([
    ...
    Y(
      x(
        ...
        B(([[y, L], u, g, C, k]) => {
          let O = L && C, V = "auto";
          return O && (V = tr(u, g || k), O = O && V !== false), { followOutputBehavior: V, shouldFollow: O, totalCount: y };
        }),
        P(({ shouldFollow: y }) => y)
      ),
    ...
    Y(
      x(
        ...
        P(([y, , L]) => y !== false && L),
        Ot(
          ({ value: y }, [, L]) => ({ refreshed: y === L, value: L }),
      ...
      y !== false && !L.atBottom && L.notAtBottomBecause === "VIEWPORT_HEIGHT_DECREASING" && f("auto");
    });
    const S = T(null), H = U();
    return z(
      Fe(
      ...
      x(
        at(x(H, Ut(1)), c),
        $(W(S), l, v, p),
        B(([[y, L], u, g, C, k]) => L && g && (u == null ? void 0 : u({ context: k, totalCount: y, scrollingInProgress: C }))),
        P((y) => !!y),
        zt(0)
      ),
      (y) => {
  ...
  ([
    ...
    const R = Tt(
      x(
        ...
        $(i),
        Ot(
          ([, f, a, S], [{ bottom: H, items: y, offsetBottom: L, totalCount: u }, g]) => {
            const C = H + L;
            let k = 0;
            return a === u && f.length > 0 && y.length > 0 && (y[0].originalIndex === 0 && f[0].originalIndex === 0 || (k = C - S, k !== 0 && (k += g))), [k, y, u, C];
          },
          [0, [], 0, 0]
        ),
        P(([f]) => f !== 0),
...
function Je(t, e, n) {
  ...
  const v = import_react.default.forwardRef(function(a, S) {
    const { children: H, ...y } = a, [L] = import_react.default.useState(() => ye(Eo(t), (C) => {
      c(C, y);
    })), [u] = import_react.default.useState(pn(m, L));
    Ie(() => {
      for (const C of i)
        C in y && Y(u[C], y[C]);
      return () => {
      ...
      c(L, y);
    }), import_react.default.useImperativeHandle(S, mn(d(L)));
    const g = n;
    return (0, import_jsx_runtime.jsx)(l.Provider, { value: L, children: n === void 0 ? H : (0, import_jsx_runtime.jsx)(g, { ...ar([...o, ...r, ...i], y), children: H }) });
  }), p = (f) => {
    ...
    const S = import_react.default.useContext(l)[f], [H, y] = import_react.default.useState(pn(it, S));
    return Ie(
      () => Y(S, (L) => {
        L !== H && y(mn(L));
      }),
...
var lo = import_react.default.createContext(void 0);
...
var co = typeof document > "u" ? import_react.default.useEffect : import_react.default.useLayoutEffect;
function ke(t) {
  return "self" in t;
}
function dr(t) {
...
function uo(t, e, n, o = Jt, r, s) {
  ...
  import_react.default.useEffect(() => {
    const p = r ?? i.current;
    return gn(p), o(r ?? i.current), d({ suppressFlushSync: true, target: p }), p.addEventListener("scroll", d, { passive: true }), () => {
...
var fr = j(() => {
  const t = T((l) => `Item ${l}`), e = T((l) => `Group ${l}`), n = T({}), o = T(tn), r = T("div"), s = T(Jt), i = (l, c = null) => ht(
    x(
      n,
      B((d) => d[l]),
      nt()
...
var pr = ({ height: t }) => (0, import_jsx_runtime.jsx)("div", { style: { height: t } });
var hr = { overflowAnchor: "none", position: Qe(), zIndex: 1 };
var ao = { overflowAnchor: "none" };
var gr = { ...ao, display: "inline-block", height: "100%" };
var En = import_react.default.memo(function({ showTopList: e = false }) {
  const n = A("listState"), o = Ct("sizeRanges"), r = A("useWindowScroll"), s = A("customScrollParent"), i = Ct("windowScrollContainerState"), l = Ct("scrollContainerState"), c = s || r ? i : l, d = A("itemContent"), m = A("context"), v = A("groupContent"), p = A("trackItemSizes"), I = A("itemSize"), w = A("log"), R = Ct("gap"), h = A("horizontalDirection"), { callbackRef: f } = _n(
    o,
    I,
    p,
    e ? Jt : c,
  ...
  return !e && n.totalCount === 0 && H !== null && H !== void 0 ? (0, import_jsx_runtime.jsx)(H, { ...ot(H, m) }) : (0, import_jsx_runtime.jsx)(
    L,
    {
      ...
      children: (e ? n.topItems : n.items).map((F) => {
        ...
        return k ? (0, import_react.createElement)(
          y,
          {
            ...ot(y, m),
            height: F.size,
...
var vr = import_react.default.memo(function() {
  const e = A("HeaderComponent"), n = Ct("headerHeight"), o = A("HeaderFooterTag"), r = Lt(
...
var Tr = import_react.default.memo(function() {
  const e = A("FooterComponent"), n = Ct("footerHeight"), o = A("HeaderFooterTag"), r = Lt(
    import_react.default.useMemo(
      () => (i) => {
        n(Ht(i, "height"));
      },
...
function nn({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return import_react.default.memo(function({ children: s, style: i, context: l, ...c }) {
    const d = n("scrollContainerState"), m = e("ScrollerComponent"), v = n("smoothScrollTargetReached"), p = e("scrollerRef"), I = e("horizontalDirection") || false, { scrollByCallback: w, scrollerRef: R, scrollToCallback: h } = uo(
      d,
      v,
      m,
      p,
...
function on({ useEmitter: t, useEmitterValue: e, usePublisher: n }) {
  return import_react.default.memo(function({ children: s, style: i, context: l, ...c }) {
    const d = n("windowScrollContainerState"), m = e("ScrollerComponent"), v = n("smoothScrollTargetReached"), p = e("totalListHeight"), I = e("deviation"), w = e("customScrollParent"), R = import_react.default.useRef(null), h = e("scrollerRef"), { scrollByCallback: f, scrollerRef: a, scrollToCallback: S } = uo(
      d,
      v,
      m,
      h,
...
var Cr = ({ children: t }) => {
  const e = import_react.default.useContext(Re), n = Ct("viewportHeight"), o = Ct("fixedItemHeight"), r = A("alignToBottom"), s = A("horizontalDirection"), i = import_react.default.useMemo(
    ...
    [n, s]
  ), l = Lt(i, true, A("skipAnimationFrameInResizeObserver"));
  return import_react.default.useEffect(() => {
...
var wr = ({ children: t }) => {
  const e = import_react.default.useContext(Re), n = Ct("windowViewportRect"), o = Ct("fixedItemHeight"), r = A("customScrollParent"), s = A("useWindowScroll"), i = A("topListHeight"), l = Ue(
    n,
    r,
    A("skipAnimationFrameInResizeObserver")
  ), c = A("alignToBottom");
  ...
  }, [e, n, o]), (0, import_jsx_runtime.jsx)("div", { "data-viewport-type": "window", ref: l, style: en(c, s, i), children: t });
};
var yr = ({ children: t }) => {
  const e = A("TopItemListComponent") ?? "div", n = A("headerHeight"), o = { ...xr, marginTop: `${n}px` }, r = A("context");
...
var br = import_react.default.memo(function(e) {
  ...
  return (0, import_jsx_runtime.jsxs)(r || n ? Hr : Rr, { ...e, context: s, children: [
    o && (0, import_jsx_runtime.jsx)(yr, { children: (0, import_jsx_runtime.jsx)(En, { showTopList: true }) }),
    (0, import_jsx_runtime.jsxs)(r || n ? wr : Cr, { children: [
...
var Rr = nn({ useEmitter: rn, useEmitterValue: A, usePublisher: Ct });
var Hr = on({ useEmitter: rn, useEmitterValue: A, usePublisher: Ct });
var rs = mo;
var ss = mo;
var Er = j(() => {
  const t = T((d) => (0, import_jsx_runtime.jsxs)("td", { children: [
    ...
    "Group ",
    d
  ] })), o = T(null), r = T(null), s = T({}), i = T(tn), l = T(Jt), c = (d, m = null) => ht(
    x(
      s,
      B((v) => v[d]),
      nt()
...
var Or = ({ height: t }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { height: t } }) });
var Lr = ({ height: t }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { border: 0, height: t, padding: 0 } }) });
var kr = { overflowAnchor: "none" };
var Bn = { position: Qe(), zIndex: 2, overflowAnchor: "none" };
var On = import_react.default.memo(function({ showTopList: e = false }) {
...
var zr = import_react.default.memo(function() {
  const e = _("listState"), n = _("topItemsIndexes").length > 0, o = bt("sizeRanges"), r = _("useWindowScroll"), s = _("customScrollParent"), i = bt("windowScrollContainerState"), l = bt("scrollContainerState"), c = s || r ? i : l, d = _("trackItemSizes"), m = _("itemSize"), v = _("log"), { callbackRef: p, ref: I } = _n(
    o,
    m,
    d,
    c,
  ...
  const L = (n ? e.topItems : []).reduce((O, V) => O + V.size, 0), u = e.offsetTop + S + w - L, g = e.offsetBottom, C = u > 0 ? (0, import_jsx_runtime.jsx)(f, { context: y, height: u }, "padding-top") : null, k = g > 0 ? (0, import_jsx_runtime.jsx)(f, { context: y, height: g }, "padding-bottom") : null;
  return (0, import_jsx_runtime.jsxs)(a, { "data-testid": "virtuoso-item-list", ref: p, ...ot(a, y), children: [
    C,
    n && (0, import_jsx_runtime.jsx)(On, { showTopList: true }),
    (0, import_jsx_runtime.jsx)(On, {}),
    k
  ] });
});
var Fr = ({ children: t }) => {
  const e = import_react.default.useContext(Re), n = bt("viewportHeight"), o = bt("fixedItemHeight"), r = Lt(
...
var Vr = ({ children: t }) => {
  const e = import_react.default.useContext(Re), n = bt("windowViewportRect"), o = bt("fixedItemHeight"), r = _("customScrollParent"), s = _("useWindowScroll"), i = Ue(
    n,
    r,
    _("skipAnimationFrameInResizeObserver")
  );
  return import_react.default.useEffect(() => {
    e && (o(e.itemHeight), n({ listHeight: 0, offsetTop: 0, visibleHeight: e.viewportHeight, visibleWidth: 100 }));
  }, [e, n, o]), (0, import_jsx_runtime.jsx)("div", { "data-viewport-type": "window", ref: i, style: en(false, s), children: t });
};
var Wr = import_react.default.memo(function(e) {
  const n = _("useWindowScroll"), o = _("customScrollParent"), r = bt("fixedHeaderHeight"), s = bt("fixedFooterHeight"), i = _("fixedHeaderContent"), l = _("fixedFooterContent"), c = _("context"), d = Lt(
    ...
    true,
    _("skipAnimationFrameInResizeObserver")
  ), v = o || n ? Gr : Pr, p = o || n ? Vr : Fr, I = _("TableComponent"), w = _("TableHeadComponent"), R = _("TableFooterComponent"), h = i ? (0, import_jsx_runtime.jsx)(
    w,
    {
      ref: d,
  ...
  return (0, import_jsx_runtime.jsx)(v, { ...e, ...ot(v, c), children: (0, import_jsx_runtime.jsx)(p, { children: (0, import_jsx_runtime.jsxs)(I, { style: { borderSpacing: 0, overflowAnchor: "none" }, ...ot(I, c), children: [
    h,
    (0, import_jsx_runtime.jsx)(zr, {}, "TableBody"),
    f
  ] }) }) });
});
var {
...
var Pr = nn({ useEmitter: sn, useEmitterValue: _, usePublisher: bt });
var Gr = on({ useEmitter: sn, useEmitterValue: _, usePublisher: bt });
var is = po;
var ls = po;
var Ln = {
  bottom: 0,
...
var { ceil: kn, floor: Ce, max: oe, min: ze, round: zn } = Math;
function Fn(t, e, n) {
...
var Nr = j(
  ([
    ...
    const L = T(0), u = T(0), g = T(Ln), C = T({ height: 0, width: 0 }), k = T({ height: 0, width: 0 }), O = U(), V = U(), N = T(0), Z = T(null), F = T({ column: 0, row: 0 }), mt = U(), q = U(), Q = T(false), gt = T(0), lt = T(true), St = T(false), Ft = T(false);
    Y(
      x(
        w,
        $(gt),
      ...
      ([, b]) => {
        b && (M(C, b.viewport), M(k, b.item), M(F, b.gap), b.scrollTop > 0 && (M(Q, true), yt(x(d, Ut(1)), (D) => {
          M(Q, false);
        }), M(c, { top: b.scrollTop })));
      }
    ), z(
        ...
        B(
          ([
            ...
            if (xt === 0 && (b === 0 || ln === 0))
              return Ln;
            if (Ee === 0) {
              const fn = Ye(Vt, b), So = fn + Math.max(xt - 1, 0);
            ...
            const cn = Fn(qt, Mt, ct), { bottom: un, top: an } = Vn(X, st, tt, cn), dn = kn(b / ge), Io = dn * he + (dn - 1) * ee - un;
            return { bottom: un, itemHeight: he, items: cn, itemWidth: Ee, offsetBottom: Io, offsetTop: an, top: an };
          }
        )
      ),
      g
    ...
    z(Et, I.scrollSeekRangeChanged), z(
      x(
        ...
        B(([b, D, K, st, tt]) => {
          ...
          let Wt = _e(D, tt, K, Vt);
          return ct === "end" ? Wt = zn(Wt - D.height + K.height) : ct === "center" && (Wt = zn(Wt - D.height / 2 + K.height / 2)), ut !== void 0 && ut !== 0 && (Wt += ut), { behavior: xt, top: Wt };
        })
      ),
      c
    );
...
function _e(t, e, n, o) {
  const r = ho(t.width, n.width, e.column), s = Ce(o / r), i = s * n.height + oe(0, s - 1) * e.row;
  return i > 0 ? i + e.row : i;
}
var Dr = j(() => {
  const t = T((v) => `Item ${v}`), e = T({}), n = T(null), o = T("virtuoso-grid-item"), r = T("virtuoso-grid-list"), s = T(tn), i = T("div"), l = T(Jt), c = (v, p = null) => ht(
    x(
      e,
      B((I) => I[v]),
      nt()
...
var Ur = import_react.default.memo(function() {
  const e = et("gridState"), n = et("listClassName"), o = et("itemClassName"), r = et("itemContent"), s = et("computeItemKey"), i = et("isSeeking"), l = wt("scrollHeight"), c = et("ItemComponent"), d = et("ListComponent"), m = et("ScrollSeekPlaceholder"), v = et("context"), p = wt("itemDimensions"), I = wt("gap"), w = et("log"), R = et("stateRestoreInProgress"), h = wt("reportReadyState"), f = Lt(
    import_react.default.useMemo(
      () => (a) => {
...
var Kr = import_react.default.memo(function() {
  const e = et("HeaderComponent"), n = wt("headerHeight"), o = et("headerFooterTag"), r = Lt(
    import_react.default.useMemo(
      () => (i) => {
        n(Ht(i, "height"));
      },
...
var jr = import_react.default.memo(function() {
  const e = et("FooterComponent"), n = wt("footerHeight"), o = et("headerFooterTag"), r = Lt(
    import_react.default.useMemo(
      () => (i) => {
        n(Ht(i, "height"));
      },
...
var qr = ({ children: t }) => {
  const e = import_react.default.useContext(lo), n = wt("itemDimensions"), o = wt("viewportDimensions"), r = Lt(
    import_react.default.useMemo(
      () => (s) => {
...
var Yr = ({ children: t }) => {
  const e = import_react.default.useContext(lo), n = wt("windowViewportRect"), o = wt("itemDimensions"), r = et("customScrollParent"), s = et("useWindowScroll"), i = Ue(n, r, false);
  return import_react.default.useEffect(() => {
  ...
  }, [e, n, o]), (0, import_jsx_runtime.jsx)("div", { ref: i, style: en(false, s), children: t });
};
var Zr = import_react.default.memo(function({ ...e }) {
  ...
  return (0, import_jsx_runtime.jsx)(r, { ...e, ...ot(r, i), children: (0, import_jsx_runtime.jsxs)(s, { children: [
    (0, import_jsx_runtime.jsx)(Kr, {}),
    (0, import_jsx_runtime.jsx)(Ur, {}),
    (0, import_jsx_runtime.jsx)(jr, {})
  ] }) });
});
var {
  Component: Xr,
...
var Jr = nn({ useEmitter: go, useEmitterValue: et, usePublisher: wt });
var Qr = on({ useEmitter: go, useEmitterValue: et, usePublisher: wt });
function Wn(t, e, n) {
  return e !== "normal" && (e == null ? void 0 : e.endsWith("px")) !== true && n(`${t} was not resolved to pixel value correctly`, e, ft.WARN), e === "normal" ? 0 : parseInt(e ?? "0", 10);
}
var cs = Xr;
export {
  ls as GroupedTableVirtuoso,
  ss as GroupedVirtuoso,
  ft as LogLevel,
  is as TableVirtuoso,
  rs as Virtuoso,
  cs as VirtuosoGrid,
  lo as VirtuosoGridMockContext,
